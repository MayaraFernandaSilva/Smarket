@extends('layouts.user', ['back' => route('products.list'), 'title' => 'Alterar Produto'])
    ...
    @endif
        ...
        function deleteProduct(confirmed) {
            if (!confirmed) {
                ...
                window.location = "{{route('products.delete', $product)}}";
            }
        }
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <panel title="Editar Produto" body-class="no-in-p">
                    <form id="product-form" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="saveProduct(this)" action="{{route('products.update', $product)}}">
                        {{ csrf_field() }}
                        {{ method_field('patch') }}

                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }} col-md-6 image">
                            <label for="image-input" style="width: 100%;">
                                <img id="image" src="{{ asset($product->image ? $product->image : 'img/NoImage_770x444.png') }}" alt="">
                            </label>
                            <input id="image-input" type="file" name="image" style="display: none" value="{{ $product->image ? asset($product->image) : '' }}" accept="image/png, image/jpeg" onchange="validateImageType(this)">
                        ...
                        <div class="form-group{{ $errors->has('cod') ? ' has-error' : '' }} col-md-6">
                            ...
                            <div class="col-md-8">
                                <input id="cod" type="text" class="form-control" name="cod" value="{{ $product->id }}" readonly{{ $errors->has('cod') ? ' autofocus' : '' }}>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} col-md-6">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $product->name }}" required{{ $errors->has('name') ? ' autofocus' : '' }}>
                        ...
                        <div class="form-group{{ $errors->has('qty') ? ' has-error' : '' }} col-md-6">
                            ...
                            <div class="col-md-8">
                                <input id="qty" type="number" class="form-control" name="qty" value="{{ $product->qty }}" required{{ $errors->has('qty') ? ' autofocus' : '' }}>
                        ...
                        <div class="form-group{{ $errors->has('brand') ? ' has-error' : '' }} col-md-6">
                            ...
                            <div class="col-md-8">
                                <input id="brand" type="text" class="form-control" name="brand" value="{{ $product->brand }}" required{{ $errors->has('brand') ? ' autofocus' : '' }}>
                        ...
                        <div class="form-group{{ $errors->has('dept') ? ' has-error' : '' }} col-md-4">
                            ...
                            <div class="col-md-8">
                                <input id="dept" type="text" class="form-control" name="dept" value="{{ $product->dept }}" required{{ $errors->has('dept') ? ' autofocus' : '' }}>
                        ...
                        <div class="form-group{{ $errors->has('weight') ? ' has-error' : '' }} col-md-4">
                            ...
                            <div class="col-md-8">
                                <input id="weight" type="number" step="any" class="form-control" name="weight" value="{{ $product->weight }}" required{{ $errors->has('weight') ? ' autofocus' : '' }}>
                        ...
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }} col-md-4">
                            ...
                            <div class="col-md-8">
                                <input id="price" type="number" step="any" class="form-control" name="price" value="{{ $product->price }}" required{{ $errors->has('price') ? ' autofocus' : '' }}>
                        ...
                        <div class="form-group{{ $errors->has('dtvalue') ? ' has-error' : '' }} col-md-4">
                            <label for="dtvalue" class="col-md-4 control-label">Date*</label>

                            <div class="col-md-8">
                                <input id="dtvalue" type="number" step="any" class="form-control" name="dtvalue" value="{{ $product->dtvalue }}" required{{ $errors->has('dtvalue') ? ' autofocus' : '' }}>

                                @if ($errors->has('dtvalue'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('dtvalue') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }} col-md-12" style="margin-bottom: 0;">
                            ...
                            <div class="col-md-10-67">
                                <textarea id="desc" class="form-control" name="desc" required{{ $errors->has('desc') ? ' autofocus' : '' }}>{{ $product->desc }}</textarea>
                        ...
                        <div class="col-md-4 col-md-offset-2 buttons">
                            <iconbutton type="submit">Salvar</iconbutton>
                        </div>

                        <div class="col-md-4 buttons">
                            <iconbutton type="button" class="delete" onclick="deleteProduct()">Excluir</iconbutton>
                        </div>
                    </form>
                </panel>
            </div>
